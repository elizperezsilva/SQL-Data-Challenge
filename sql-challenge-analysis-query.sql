...
-- 5. List first name, last name, and sex of each employees whose first name is Hercules and last names begin with the letter B.
...
-- 7. List each employees in the Sales and Development departments, including their employee number, last name, first name, and department name.
SELECT employees.emp_no, employees.last_name, employees.first_name, departments.dept_name
FROM employees
JOIN dept_emp
ON dept_emp.emp_no = employees.emp_no
